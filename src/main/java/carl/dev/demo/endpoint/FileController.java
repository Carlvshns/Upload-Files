...
public class FileController {
  ...
  @GetMapping("/file/{id}")
  public ResponseEntity<StreamingResponseBody> getFileMP4(@PathVariable String id) throws IOException{
    
    File file = new File("https://carlvs-cdn-video/herokuapp.com/medias/files/"+id);
        if (!file.isFile()) {
